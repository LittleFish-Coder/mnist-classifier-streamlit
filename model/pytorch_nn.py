...
# model = NN(784, 10)
# x = torch.randn(64, 784)  # 64 batches of  (28*28) dim picture
# print(x.shape)
# print(model(x).shape)
...
for epoch in range(num_epochs):
    for batch_id, (data, targets) in enumerate(train_loader):
        ...
        # flatten the rest dimension
        data = data.reshape(data.shape[0], -1)  # torch.Size([64, 784])
